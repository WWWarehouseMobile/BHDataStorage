...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, BHKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	SAMKeychainErrorBadArguments = -1001,
};

/** SAMKeychain error domain */
extern NSString *const kBHKeychainErrorDomain;

/** Account name. */
extern NSString *const kBHKeychainAccountKey;
 ...
 */
extern NSString *const kBHKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kBHKeychainClassKey;

/** Item description. */
extern NSString *const kBHKeychainDescriptionKey;

/** Item label. */
extern NSString *const kBHKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kBHKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kBHKeychainWhereKey;
